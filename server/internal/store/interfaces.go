...
type ChatStorer interface {
	...
	UpdateServer(ctx context.Context, serverID string, name, iconURL, welcomeMessage, rules *string, onboardingEnabled, rulesRequired, defaultChannelPrivacy *bool, joinMessageEnabled *bool, joinMessageTemplate, joinMessageChannelID *string) (*models.Server, error)
	GetFirstPublicChannel(ctx context.Context, serverID string) (*models.Channel, error)
